...
function bacapilgan(idsoal) {
	$.ajax({
		url: "dosen/banksoal/bacapilgan/" + idsoal,
		type: "POST",
		dataType: "JSON",
...
function bacaesai(idsoal) {
	$.ajax({
		url: "dosen/banksoal/bacaesai/" + idsoal,
		type: "POST",
		dataType: "JSON",
		success: function (data) {
			var html = "";
...
function hapuspilgan(id) {
	if (confirm("Anda yakin hapus ?")) {
		$.ajax({
			url: "dosen/banksoal/hapuspilgan/" + id,
			type: "POST",
			dataType: "JSON",
			success: function (data) {
				if (data.status) {
...
function hapusesai(id) {
	if (confirm("Anda yakin hapus ?")) {
		$.ajax({
			url: "dosen/banksoal/hapusesai/" + id,
			type: "POST",
			dataType: "JSON",
			success: function (data) {
				if (data.status) {
