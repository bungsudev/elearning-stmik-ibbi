...
$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => "http://localhost/online/assets/ckfinder/userfiles/",
    // 'root'         => 'assets/img/ckfinder/userfiles', // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
