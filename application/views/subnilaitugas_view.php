...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a
				href="subnilaitugas" class="current">Nilai tugas</a> </div>
		<h1><span class="icon-briefcase"></span>
			Informasi Penilaian Nilai<small> Tugas Mahasiswa</small></h1>
	</div>
	<hr>
	<div class="container-fluid">

		<!-- modal Riwayat -->
		<div class="modal hide fade" tabindex="-1" role="dialog" id="form-riwayattugas">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h3>Riwayat Tugas Mahasiswa</h3>
					</div>
		...
		<!-- modal rubah -->
		<div class="modal hide fade" tabindex="-1" role="dialog" id="form-rubahtugas">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h3>Rubah Nilai Tugas</h3>
					</div>
					<div class="modal-body">
						<form class="form-horizontal">
							<div class="control-group">
								<label class="control-label" for="judultugas">Judul</label>
								<div class="controls">
									<input type="text" id="judultugas" name="judultugas">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="tgltugas">Tanggal selesai tugas</label>
								<div class="controls">
									<input type="date" id="tgltugas" name="tgltugas">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="nilaitugas">Nilai tugas</label>
								<div class="controls">
									<input type="text" id="nilaitugas" name="nilaitugas">
								</div>
							</div>
						</form>
					</div>
		...
		<div class="row-fluid">
			<div class="span12">
				...
				<div class="widget-box">
					<button class="btn btn-success pull-right" data-toggle="modal" data-target="#form-koreksi"
							...
							<tbody>
								<tr>
									...
									<td style="width:120px;"><button class="btn btn-info btn-block" data-toggle="modal"
											data-target="#form-riwayattugas">
											<span class="icon-pencil"></span> Riwayat tugas</button>
									</td>
