...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a
				href="subnilaiuts" class="current">Nilai uts</a> </div>
		<h1><span class="icon-briefcase"></span>
			Informasi Penilaian Nilai<small> UTS Mahasiswa</small></h1>
	</div>
	<hr>
	<div class="container-fluid">

		<!-- modal Riwayat -->
		<div class="modal hide fade" tabindex="-1" role="dialog" id="form-riwayatuts">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h3>Riwayat UTS Mahasiswa</h3>
					</div>
		...
		<!-- modal rubah -->
		<div class="modal hide fade" tabindex="-1" role="dialog" id="form-rubahuts">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h3>Rubah Nilai UTS</h3>
					</div>
					<div class="modal-body">
						<form class="form-horizontal">
							<div class="control-group">
								<label class="control-label" for="juduluts">Judul</label>
								<div class="controls">
									<input type="text" id="juduluts" name="juduluts">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="tgluts">Tanggal selesai uts</label>
								<div class="controls">
									<input type="date" id="tgluts" name="tgluts">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="nilaiuts">Nilai UTS</label>
								<div class="controls">
									<input type="text" id="nilaiuts" name="nilaiuts">
								</div>
							</div>
						</form>
					</div>
							...
							<tbody>
								<tr>
									...
									<td style="width:120px;"><button class="btn btn-info btn-block" data-toggle="modal"
											data-target="#form-riwayatuts">
											<span class="icon-pencil"></span> Riwayat uts</button>
									</td>
