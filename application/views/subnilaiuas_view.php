...
<div id="content">
	<div id="content-header">
		<div id="breadcrumb"> <a href="home" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a
				href="subnilaiuas" class="current">Nilai UAS</a> </div>
		<h1><span class="icon-briefcase"></span>
			Informasi Penilaian Nilai<small> UAS Mahasiswa</small></h1>
	</div>
	<hr>
	<div class="container-fluid">

		<!-- modal Riwayat -->
		<div class="modal hide fade" tabindex="-1" role="dialog" id="form-riwayatuas">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h3>Riwayat Uas Mahasiswa</h3>
					</div>
		...
		<!-- modal rubah -->
		<div class="modal hide fade" tabindex="-1" role="dialog" id="form-rubahuas">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h3>Rubah Nilai UAS</h3>
					</div>
					<div class="modal-body">
						<form class="form-horizontal">
							<div class="control-group">
								<label class="control-label" for="juduluas">Judul</label>
								<div class="controls">
									<input type="text" id="juduluas" name="juduluas">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="tgluas">Tanggal selesai uas</label>
								<div class="controls">
									<input type="date" id="tgluas" name="tgluas">
								</div>
							</div>
							<div class="control-group">
								<label class="control-label" for="nilaiuas">Nilai UAS</label>
								<div class="controls">
									<input type="text" id="nilaiuas" name="nilaiuas">
								</div>
							</div>
						</form>
					</div>
							...
							<tbody>
								<tr>
									...
									<td style="width:120px;"><button class="btn btn-info btn-block" data-toggle="modal"
											data-target="#form-riwayatuas">
											<span class="icon-pencil"></span> Riwayat UAS</button>
									</td>
